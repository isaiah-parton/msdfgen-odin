...
extern "C"
{
    ...
    {
    		ImmediateAtGen *gen = msdfgen::make<ImmediateAtGen>(width, height);
      	gen->setAttributes(GeneratorAttributes{config: msdfgen::MSDFGeneratorConfig(false, msdfgen::ErrorCorrectionConfig())});
        return (msaImmediateAtlasGenerator *)gen;
    }
